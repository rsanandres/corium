...
// JAXStatsCollectorStatus defines the observed state of JAXStatsCollector.
type JAXStatsCollectorStatus struct {
...
type JAXStatsCollector struct {
	...
	Spec   JAXStatsCollectorSpec   `json:"spec,omitempty"`
	Status JAXStatsCollectorStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// JAXStatsCollectorList contains a list of JAXStatsCollector.
type JAXStatsCollectorList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []JAXStatsCollector `json:"items"`
}

func init() {
	SchemeBuilder.Register(&JAXStatsCollector{}, &JAXStatsCollectorList{})
}
