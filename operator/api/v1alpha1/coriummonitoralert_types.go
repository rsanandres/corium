...
// CoriumMonitorAlertSpec defines the desired state of CoriumMonitorAlert.
type CoriumMonitorAlertSpec struct {
	...
	// CollectorRef references the CoriumMonitorCollector to monitor
	// +kubebuilder:validation:MinLength=1
...
// CoriumMonitorAlertStatus defines the observed state of CoriumMonitorAlert.
type CoriumMonitorAlertStatus struct {
...
// +kubebuilder:resource:shortName=cma
...
// CoriumMonitorAlert is the Schema for the coriummonitoralerts API
type CoriumMonitorAlert struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   CoriumMonitorAlertSpec   `json:"spec,omitempty"`
	Status CoriumMonitorAlertStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// CoriumMonitorAlertList contains a list of CoriumMonitorAlert
type CoriumMonitorAlertList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CoriumMonitorAlert `json:"items"`
}

func init() {
	SchemeBuilder.Register(&CoriumMonitorAlert{}, &CoriumMonitorAlertList{})
}
