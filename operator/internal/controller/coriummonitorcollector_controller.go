...
// CoriumMonitorCollectorReconciler reconciles a CoriumMonitorCollector object
type CoriumMonitorCollectorReconciler struct {
	client.Client
	Scheme   *runtime.Scheme
	Recorder record.EventRecorder
}

// +kubebuilder:rbac:groups=monitor.corium.io,resources=coriummonitorcollectors,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=monitor.corium.io,resources=coriummonitorcollectors/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=monitor.corium.io,resources=coriummonitorcollectors/finalizers,verbs=update
// +kubebuilder:rbac:groups=monitor.corium.io,resources=coriummonitorconfigs,verbs=get;list;watch
// +kubebuilder:rbac:groups="",resources=pods,verbs=get;list;watch
// +kubebuilder:rbac:groups="",resources=configmaps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups="",resources=events,verbs=create;patch

func (r *CoriumMonitorCollectorReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	// Fetch the referenced CoriumMonitorConfig
	...
	if err := r.Get(ctx, types.NamespacedName{
		...
		collector.Status.CollectionStatus = alertStatusError
	...
	if !config.Spec.Enabled {
		...
		meta.SetStatusCondition(&collector.Status.Conditions, metav1.Condition{
			...
			Message:            "Referenced CoriumMonitorConfig is disabled",
			LastTransitionTime: metav1.Now(),
			ObservedGeneration: collector.Generation,
		})
	...
	meta.SetStatusCondition(&collector.Status.Conditions, metav1.Condition{
		...
		Reason:             "ConfigReady",
		Message:            "Referenced CoriumMonitorConfig is available and enabled",
		LastTransitionTime: metav1.Now(),
		ObservedGeneration: collector.Generation,
	})
	...
	if err := r.Status().Update(ctx, collector); err != nil {
		logger.Error(err, "unable to update CoriumMonitorCollector status")
		return ctrl.Result{}, err
	}
...
func (r *CoriumMonitorCollectorReconciler) ensureMetricsConfigMap(
	ctx context.Context,
	collector *monitorv1alpha1.CoriumMonitorCollector,
	cmName string,
	metricsJSON string,
		...
		cm = &corev1.ConfigMap{
			ObjectMeta: metav1.ObjectMeta{
				...
				Labels: map[string]string{
					"app.kubernetes.io/managed-by": "corium-operator",
					"monitor.corium.io/collector":  collector.Name,
				},
			},
...
func (r *CoriumMonitorCollectorReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&monitorv1alpha1.CoriumMonitorCollector{}).
		Owns(&corev1.ConfigMap{}).
		Named("coriummonitorcollector").
		Complete(r)
}
