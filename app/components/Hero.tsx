...
<h1 className="text-2xl font-semibold tracking-tight">{profile.name}</h1>
        ...
        <p className="text-sm text-text-secondary dark:text-[#8e8ea0] mt-1">{profile.title}</p>
      </div>
      <p className="text-base text-text-secondary dark:text-[#a0a0b0] leading-relaxed mb-4">
        {profile.tagline}
      </p>
    </section>
  )
